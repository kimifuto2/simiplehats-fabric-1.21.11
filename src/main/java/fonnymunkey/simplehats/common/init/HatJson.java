...
public class HatJson {
    ...
    private static final List<HatEntry> defaultHats = Arrays.asList(
            ...
            new HatEntry("farmerbrim", Rarity.UNCOMMON, 5, 0, new HatEntry.HatDyeSettings(true, 7895160), HatEntry.HatSeason.EASTER),
            ...
            new HatEntry("summerhat", Rarity.COMMON, 5, 0, new HatEntry.HatDyeSettings(true, 11330558)),
            ...
            new HatEntry("rabi_en_rose", Rarity.RARE, 5, 1),
            ...
            new HatEntry("bee_on_head", Rarity.RARE, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:falling_honey", 0.02F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_HEAD)),
            new HatEntry("beetle_on_head", Rarity.UNCOMMON, 5, 0),
            new HatEntry("binky", Rarity.COMMON, 5, 0, new HatEntry.HatDyeSettings(true, 36095)),
            new HatEntry("cardboard_box", Rarity.COMMON, 5, 0),
            new HatEntry("cat_hat", Rarity.UNCOMMON, 5, 0, new HatEntry.HatDyeSettings(true, 16752640)),
            new HatEntry("cat_on_head", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16743680)),
            new HatEntry("caterpillar_on_head", Rarity.RARE, 5, 0),
            new HatEntry("chocolate_sauced", Rarity.RARE, 5, 0),
            new HatEntry("crystal_horns", Rarity.EPIC, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:glow", 0.1F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_HEAD)),
            new HatEntry("dipper", Rarity.UNCOMMON, 5, 0),
            new HatEntry("druid_antlers", Rarity.UNCOMMON, 5, 0, new HatEntry.HatDyeSettings(true, 5299200)),
            new HatEntry("druid_antlers_rare", Rarity.EPIC, 5, 0, new HatEntry.HatDyeSettings(true, 5299200), new HatEntry.HatParticleSettings(true, "minecraft:spore_blossom_air", 0.05F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_HEAD)),
            new HatEntry("eevee_ears", Rarity.UNCOMMON, 5, 0),
            new HatEntry("eyeholder_beeholder", Rarity.EPIC, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:falling_honey", 0.04F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_HEAD)),
            new HatEntry("eyeholder_dark", Rarity.UNCOMMON, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:soul_fire_flame", 0.05F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_HEAD)),
            new HatEntry("eyeholder_evil", Rarity.UNCOMMON, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:portal", 0.1F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_HEAD)),
            new HatEntry("eyeholder_warm", Rarity.RARE, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:lava", 0.03F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_HEAD)),
            new HatEntry("eyeholder_xanath", Rarity.EPIC, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:enchant", 0.2F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_HEAD)),
            new HatEntry("gnome", Rarity.COMMON, 5, 0, new HatEntry.HatDyeSettings(true, 65280)),
            new HatEntry("gnome_clover_wig", Rarity.UNCOMMON, 5, 1),
            new HatEntry("greaser", Rarity.UNCOMMON, 5, 0),
            new HatEntry("hat_of_discipline", Rarity.RARE, 5, 0),
            new HatEntry("ladybug_on_head", Rarity.UNCOMMON, 5, 0),
            new HatEntry("lil_bows", Rarity.RARE, 5, 0),
            new HatEntry("lil_termagant", Rarity.EPIC, 5, 0),
            new HatEntry("medusa", Rarity.RARE, 5, 0),
            new HatEntry("mimic_head", Rarity.UNCOMMON, 5, 0),
            new HatEntry("mimic_head_dark", Rarity.RARE, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:soul", 0.05F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_HEAD)),
            new HatEntry("mimic_head_gold", Rarity.EPIC, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:electric_spark", 0.05F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_HEAD)),
            new HatEntry("mindflayer", Rarity.RARE, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:glow", 0.1F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_FULL)),
            new HatEntry("mindflayer_alhoon", Rarity.EPIC, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:enchant", 0.2F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_FULL)),
            new HatEntry("octodad", Rarity.EPIC, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:splash", 0.1F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_FULL)),
            new HatEntry("pika_ears", Rarity.UNCOMMON, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:electric_spark", 0.1F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_FULL)),
            new HatEntry("right_hand_hat", Rarity.COMMON, 5, 1),
            new HatEntry("round_purple_wig", Rarity.COMMON, 5, 1),
            new HatEntry("round_red_wig", Rarity.COMMON, 5, 1),
            new HatEntry("slime_cube_dnd", Rarity.EPIC, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:soul", 0.05F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_HEAD)),
            new HatEntry("slime_head", Rarity.RARE, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:spore_blossom_air", 0.04F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_HEAD)),
            new HatEntry("stinkycheeseman", Rarity.EPIC, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:mycelium", 0.12F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_HEAD)),
            new HatEntry("stuck_lollipop", Rarity.COMMON, 5, 0),
            new HatEntry("tanuki_leaf", Rarity.UNCOMMON, 5, 0),
            new HatEntry("the_noisier", Rarity.EPIC, 5, 0),
            new HatEntry("thumbnail", Rarity.EPIC, 5, 0),
            new HatEntry("tick_on_head", Rarity.COMMON, 5, 0),
            new HatEntry("toast", Rarity.COMMON, 5, 0),
            new HatEntry("toilet", Rarity.RARE, 5, 0, new HatEntry.HatParticleSettings(true, "minecraft:splash", 0.1F, HatEntry.HatParticleSettings.HatParticleMovement.TRAILING_HEAD)),
            new HatEntry("tomato_splats", Rarity.EPIC, 5, 0),
            new HatEntry("traffic_cone", Rarity.RARE, 5, 0),
            new HatEntry("udder_hat", Rarity.COMMON, 5, 0),
            new HatEntry("worm_hat", Rarity.COMMON, 5, 0)
            );
    ...
    private static boolean validateName(String name) {
        for(char c : name.toCharArray()) {
            if(!isValidHatNameChar(c)) return false;
        }
        return true;
    }

    private static boolean isValidHatNameChar(char c) {
